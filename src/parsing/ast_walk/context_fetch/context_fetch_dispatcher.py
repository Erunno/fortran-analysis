...
from parsing.ast_walk.ast_nodes.expression_ast import DataPointerObjectNode, DataRefNode, IntrinsicFunctionNode, LiteralNode, NameNode, OperatorNode, ParenthesisNode, PartRefNode, ReferenceNode
...
symbol_fetch_dispatcher.register(StructReferenceSymbolFetcher).for_node(DataPointerObjectNode)
